...
const learningPath = [
  ...
  },
  {
    ...
    description: "Essential for Full-Stack Development",
    points: [
  ...
  },
  {
    ...
    description: "Advanced SQL + Analytics for Data Careers",
    points: [
  ...
  },
  {
    ...
    description: "Practical Learning & Interview Preparation",
    points: [
  ...
  },
  {
    ...
    description: "For Tech Job Seekers in FAANG/Startups",
    points: [
...
const courseBenefits = [
  {
    title: "6 Advanced Courses",
    icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"
  },
  {
    title: "60+ Hours of Content",
...
const faqs = [
  {
    question: "What prerequisites are needed for the Intermediate Course?",
    answer: "You should have basic programming knowledge, understanding of HTML/CSS/JavaScript fundamentals, and some experience with building simple web applications. Our beginner course or equivalent experience is recommended."
  },
  {
    question: "What makes this different from the Beginner Course?",
    answer: "The Intermediate Course focuses on advanced concepts, real-world applications, and industry-standard tools. You'll build complex projects, learn modern frameworks, and develop professional-grade applications."
  },
  {
    question: "Will I be job-ready after completing this course?",
    answer: "Yes! The course is designed to prepare you for junior developer positions. You'll build a portfolio of real projects, learn industry-relevant skills, and receive career guidance and interview preparation support."
  }
];
      ...
      <div className="relative bg-[#0A2818] py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-[#E5E7EB] mb-8">One-time payment • 6 months access • Premium support</p>
            ...
            <Button 
              ...
              onClick={() => window.location.href = 'https://courses.30dayscoding.com/courses/intermediate-1741177849785-67c843f9ddabff159b50c83f'}
            >
              <span>Buy Now</span>
              <svg 
                className="w-6 h-6" 
