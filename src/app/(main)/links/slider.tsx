...
export function Slider({
  ...
  const [url, setUrl] = React.useState("Kowl-SSE_Pk");
            ...
            >
              ...
              >
                <Image
                  ...
                  fill
                />
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-prime p-1 rounded-full">
                  <div className="bg-white p-5 rounded-full">
                    <Play className="w-7 h-7 stroke-[3] stroke-prime fill-prime" />
                  </div>
                </div>
              </AspectRatio>
