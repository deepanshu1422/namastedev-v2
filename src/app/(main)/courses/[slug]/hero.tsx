...
export default function Hero({
  ...
  return (
    <div className={`w-full grid bg-zinc-950/60`}>
      <div className="tab:p-[4.5rem_5.5rem_3.75rem] max-tab:pt-[3rem] max-tab:pb-[2.5rem] m-auto max-w-[90rem] flex flex-auto max-tab:flex-col w-full justify-between text-white gap-3 sm:gap-7 h-full">
        <section className="grid gap-2 h-fit tab:max-w-[50%]">
          <Link
            href={"/courses"}
            className="flex text-white/70 items-center gap-2 w-fit hover:text-white transition-all hover:underline max-tab:px-11 max-phone:px-6"
          >
          ...
          <p className="tab:max-w-2xl max-tab:px-11 max-phone:px-6 max-tab:leading-6 line-clamp-3 text-white/60 max-sm:text-sm italic font-semibold">
            8h 16m 32s of total content
          </p>
          ...
          <div className="text-white/70 max-tab:px-11 max-phone:px-6">
            Author:{" "}
          ...
          <div className="text-sm text-white/40 max-tab:px-11 max-phone:px-6">
