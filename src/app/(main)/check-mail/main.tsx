  ...
  return (
    <main className="min-h-[90vh] flex bg-white">
      <div className="mx-auto p-3 flex flex-col items-center">
        <Image src={"/mail-sent.gif"} height={300} width={300} alt="done" />
        <CardHeader className="p-1 items-center -translate-y-10">
          <span className="bg-white flex gap-2 items-center text-3xl text-black font-extrabold">
            Check Your Mail
          </span>
        ...
        <CardContent className="pt-3 pb-0 mx-auto w-full flex flex-col items-center gap-2 -translate-y-10">
          ...
          >
            <Button className="w-full bg-blue-600/90 hover:bg-blue-600 text-white">
              Go to Inbox
            </Button>
          </Link>
          ...
          <section className="mt-5 flex flex-col gap-1 items-center text-center">
            ...
            <ol className="text-balance list-decimal list-inside text-gray-700 space-y-2 items-center max-w-lg">
              <li>Check your email for a confirmation message</li>
              <li>
                Click the resource link below the invoice to schedule your session on Calendly
              </li>
