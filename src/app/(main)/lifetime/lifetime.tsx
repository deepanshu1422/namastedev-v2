  ...
  return (
    <div className="m-auto flex flex-col px-5 lg:px-20 pt-10 max-w-[75rem]">
      <span className="flex items-center justify-center gap-4 relative pb-4">
        ...
        30DaysCoding <span className="underline decoration-white decoration-4"> lifetime deal
        </span>         
        </h1>
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8 mt-4">
