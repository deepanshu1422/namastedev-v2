...
export default function Features() {
  let mentorsipPath = [
    {
      title: "1:1 calls for personalized guidance",
      svg: (
        <svg
          width="21"
          height="21"
    ...
    {
      title:
        "Access to all 10 courses - MERN, Next JS, DSA, AI, Blockchain, JavaScript, Java, Python.",
      svg: (
        <svg
          width="21"
          height="21"
    ...
    {
      title: "24/7 WhatsApp - chat access and QnA sessions with mentors.",
      svg: (
        <svg
          width="21"
          height="21"
    ...
    {
      title: "Full stack projects, SaaS tools, MVPs.",
      svg: (
        <svg
          width="21"
          height="21"
    ...
    {
      title: "Resume, cold emails, applying, etc.",
      svg: (
        <svg
          width="21"
          height="21"
    ...
    {
      title: "Interview guides, resources, etc.",
      svg: (
        <svg
          width="21"
          height="21"
  ...
  return (
    <div className="m-auto grid grid-cols-1 place-items-center px-6 lg:px-10 py-10 lg:pt-15 gap-10 max-w-[75rem]">
      <span className="flex items-center justify-center gap-4 relative">
        <hr className="max-phone:hidden h-0.5 max-lg:w-20 w-60 max-w-60 rounded bg-gradient-to-r from-0% from-transparent to-100% to-prime" />
        <h2 className="font-jakarta phone:shrink-0 text-[2rem] font-extrabold text-center">
          30DaysCoding community benefits
        </h2>
