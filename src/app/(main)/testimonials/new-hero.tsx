  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gradient-to-t from-bg from-0% to-transparent to-50%">
        <div className="tab:p-[10.5rem_5.5rem_3.75rem] max-tab:pt-[4rem] max-tab:pb-[2.5rem] m-auto max-w-[90rem] flex max-md:flex-col max-md:gap-10 justify-between items-center text-white">
