...
export default async function Home({ params: { slug } }: PageProps) {
  ...
  try {
    ...
    return (
      <main className="bg-background bg-bg min-h-svh transition-all flex flex-col">
        <Hero
          title={item.title ?? ""}
        ...
        >
          <Alert className="border-prime/80 bg-gradient-to-b from-prime/60 to-second/60 shadow-lg text-left max-w-2xl md:max-w-3xl gap-1.5 flex flex-col">
        ...
        <div className="pb-10 m-auto px-8 lg:px-5 grid gap-4 max-w-lg md:max-w-3xl">
