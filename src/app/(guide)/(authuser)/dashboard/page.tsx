...
export default async function Dashboard() {
  ...
  return (
    <div className='flex flex-col gap-2 px-4 py-5 lg:px-8'>
      ...
      <div className='min-h-60 w-full flex'><Badge className="text-white gap-1 bg-second/60 hover:bg-second/80 rounded m-auto text-base">No Purchased Courses</Badge></div>
