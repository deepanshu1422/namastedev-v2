    ...
    <div className="w-full relative">
      <div className="m-auto flex max-lg:flex-col items-start max-lg:items-center justify-between p-6 lg:p-20 gap-10 max-w-[90rem]">
        <div className="lg:w-2/5 grid gap-5 shrink">
          <span className="text-4xl max-tab:text-3xl font-bold text-pretty">
        ...
        <div className="lg:w-3/5 w-full shrink-0 flex-1 flex flex-col gap-2">
          {title.map((e, i) => (
            <div key={i} className="flex items-start gap-3 p-3 bg-gradient-to-r from-head/40 to-transparent rounded-lg shadow-inner">
