      ...
      <div className="flex bg-bg items-center justify-center text-lg text-white h-20 fixed top-0 w-full z-20 pt-2">
        ...
        >
          ...
          <section className="flex items-center gap-2">
            ...
            {
              !isLoaded ? <button className="font-jakarta flex items-center font-semibold gap-2 bg-prime/20 transition-all px-4 py-3 max-sm:py-2 rounded-md text-sm"
              >Loading...</button> : isSignedIn ? <UserButton appearance={{ elements: {
